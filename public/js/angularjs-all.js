...
!angular.$$csp() && angular.element(document).find('head').prepend('<style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style>');
// Source: bower_components/ngprogress/build/ngProgress.min.js
/*
...
// Source: bower_components/angular-gettext/dist/angular-gettext.min.js
...
// Source: bower_components/angular-naturalsort/dist/naturalSortVersionDates.min.js
/*!
